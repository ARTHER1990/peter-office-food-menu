...
2. **Smart Nutrition Calculation (มาตรฐานข้าวสวย 1 ทัพพี & ของหวานหมุนเวียน):**
   * อาหารทุกเมนูต้องมีข้อมูล `nutrition` (หรือคำนวณผ่าน `resolvedNutrition`):
     * `calories`: พลังงานรวมต่อ 1 เสิร์ฟ โดยคิดรวม **ข้าวสวย 1 ทัพพี (~80 kcal / Carbs 18g)** + กับข้าวทั้งหมด + ของหวานหมุนเวียน (ถ้ามี คิดเฉลี่ย ~130 kcal, ผลไม้ 60-80 kcal / ขนมหวาน 150-180 kcal)
     * `protein`: โปรตีน (กรัม)
